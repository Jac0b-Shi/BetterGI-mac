...
public partial class PathExecutor
{
                ...
                try
                {
                    ...
                    if (state.PendingApproach)
                    {
                        ...
                        if (shouldApproach)
                        {
                            ...
                            if (state.FlyingState)
                            {
                                ...
                                TaskControlPlatform.Current.SimulateAction(GIActions.Jump); // 第1种：点按跳跃
                            }
                            return false;
                        }
                    }
                    ...
                    if (state.FlyingState)
                    {
                        ...
                        if ((DateTime.UtcNow - _lastFlyStartTime).TotalSeconds >= 5)
                        {
                            ...
                            TaskControlPlatform.Current.SimulateAction(GIActions.Jump); // 第3种：点按跳跃
                            return false;
                        }
                        ...
                        if (_flyStillFrames >= 2)
                        {
                            ...
                            TaskControlPlatform.Current.SimulateAction(GIActions.Jump); // 第4种：点按跳跃
                            return false;
                        }
    ...
    /// </summary>
    private Task<double> ReadEskillCdAsync(string avatarName, bool updateTracking = true)
    {
