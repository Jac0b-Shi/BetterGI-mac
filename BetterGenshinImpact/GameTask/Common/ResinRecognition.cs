...
public static class ResinRecognition
{
    ...
    public static ResinRecognitionResult? RecognizeInBigMapTopBar(ImageRegion capture)
    {
        ...
        using var iconRa = iconSearchRegion.Find(RecognitionAssets.Get("AutoBoss", "OriginalResinTopIcon", captureRect.Width, captureRect.Height));
        if (iconRa.IsEmpty())
        {
            return null;
        }
        ...
        var countText = BetterGenshinImpact.GameTask.AutoFight.AutoFightRuntimePlatform.Current.OcrService.OcrWithoutDetector(inverted);
        ...
        double assetScale)
    {
        ...
        var captureRect = BetterGenshinImpact.GameTask.AutoFight.AutoFightRuntimePlatform.Current.SystemInfo.ScaleMax1080PCaptureRect;
        using var iconRa = searchRegion.Find(RecognitionAssets.Get(
