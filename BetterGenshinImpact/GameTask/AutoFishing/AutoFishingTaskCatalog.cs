...
namespace BetterGenshinImpact.GameTask.AutoFishing
{
    public class AutoFishingTaskCatalog : IBehaviourCatalog
    {
        ...
        public GetFishpond GetFishpond(
            ...
            IOverlayDrawPlatform? drawContent = null) => new GetFishpond(name, logger, predictor, blackboard, timeProvider, drawContent);
        ...
        public LiftRod LiftRod(
            ...
            Blackboard blackboard,
            TimeProvider? timeProvider = null,
            IOverlayDrawPlatform? drawContent = null) => new LiftRod(name, logger, input, predictor, blackboard, timeProvider, drawContent);
        ...
        public Fishing Fishing(
            ...
            Blackboard blackboard,
            TimeProvider? timeProvider = null,
            IOverlayDrawPlatform? drawContent = null) => new Fishing(name, logger, saveScreenshotOnError, input, blackboard, timeProvider, drawContent);
