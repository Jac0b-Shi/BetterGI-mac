...
namespace BetterGenshinImpact.GameTask.AutoFishing
{
    ...
    public partial class TurnAround : Behaviour, IScreenshotBehaviour
    {
        ...
        private TurnAround(string name, ILogger logger, IAutoFishingInput input, BgiYoloPredictor bgiYoloPredictor) : base(name)
        {
            _logger = logger;
            _input = input;
    ...
    public partial class EnterFishingMode : Behaviour, IScreenshotBehaviour
    {
        ...
        private EnterFishingMode(string name, ILogger logger, IAutoFishingInput input, InferenceSession session, Dictionary<string, float[]> prototypes, TimeProvider? timeProvider = null, CultureInfo? cultureInfo = null, IStringLocalizer? stringLocalizer = null) : base(name)
        {
            _logger = logger;
            _input = input;
            _session = session;
