...
public sealed class BvFlow
{
    ...
    {
        var virtualKey = BgiKeyMapper.ToWindowsVirtualKey(key);
...
internal sealed class BvFlowServices
{
    ...
    public required Action<int> KeyPress { get; set; }
    ...
    public static BvFlowServices Create(BvPage page)
    {
        return new BvFlowServices
        {
            ...
            GetMatchRect = region =>
            {
                ...
                var scale = BvRuntimePlatform.Current.SystemInfo.ScaleTo1080PRatio;
                return new Rect(
            ...
            KeyPress = TaskControlPlatform.Current.PressKey,
