...
#define BGI_WINE_BRIDGE_VERSION UINT16_C(5)
...
#define BGI_WINE_CAP_INPUT_CONTEXT_WAKE UINT32_C(1 << 7)
...
enum bgi_wine_status {
    ...
    BGI_WINE_STATUS_WAKE_POINT_UNSAFE = 15,
    BGI_WINE_STATUS_WAKE_CURSOR_NOT_POSITIONED = 16
};
